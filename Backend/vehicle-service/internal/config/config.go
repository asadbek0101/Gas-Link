...
func Load() *Config {
	return &Config{DBHost: ge("DB_HOST","localhost"),DBPort: ge("DB_PORT","5432"),DBUser: ge("DB_USER","gaslink"),DBPassword: ge("DB_PASSWORD","gaslink_secret_2024"),DBName: ge("DB_NAME","gaslink_db"),DBSSLMode: ge("DB_SSLMODE","disable"),Port: ge("SERVICE_PORT","8084")}
}
