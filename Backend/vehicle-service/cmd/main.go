...
import (
	...
	_ "github.com/lib/pq"
	"github.com/gaslink/vehicle-service/internal/config"
	"github.com/gaslink/vehicle-service/internal/handler"
...
func main() {
	...
	handler.NewVehicleHandler(repository.NewVehicleRepository(db)).RegisterRoutes(r)
	log.Printf("Vehicle Service on :%s", cfg.Port)
	r.Run(":" + cfg.Port)
}
